     ...
     begin
      ...
      insert into ref_apps( app_url, app_name, app_icon) values
          ...
          ( 'app/Clients.jsp',     'Clients',                      'client.gif'        ),
          ...
          ( 'app/ToDo.jsp',        'To&nbsp;Do&nbsp;Lists',        'todo.gif'          ),
          ...
          ( 'app/pHealthcare.jsp',    'Personalized<br/>Healthcare&reg;',    'personalized.gif'),
          ( 'app/pOncology.jsp',      'Personalized<br/>Oncology&reg;',      'personalized.gif'),
          ( 'app/pCardiology.jsp',    'Personalized<br/>Cardiology&reg;',    'personalized.gif'),
          ( 'app/pRheumatology.jsp',  'Personalized<br/>Rheumatology&reg;',  'personalized.gif'),
          ( 'app/pEndocrinology.jsp', 'Personalized<br/>Endocrinology&reg;', 'personalized.gif'),
          ( 'app/pNeurology.jsp',     'Personalized<br/>Neurology&reg;',     'personalized.gif');
