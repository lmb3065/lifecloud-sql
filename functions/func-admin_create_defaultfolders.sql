...
-- 2014-07-21 dbrown: set to 5 "Buckets" HEMPM
-- -----------------------------------------------------------------------------
...
begin
    ...
    insert into ref_defaultfolders(x_name, x_desc) values
        (fencrypt('Home'),                  fencrypt('Home folder')),
        (fencrypt('Emergency'),             fencrypt('Emergency folder')),
        (fencrypt('Medical'),               fencrypt('Medical folder')),
        (fencrypt('Pets'),                  fencrypt('Pets folder')),       
        (fencrypt('Memories'),              fencrypt('Memory Box folder'));
